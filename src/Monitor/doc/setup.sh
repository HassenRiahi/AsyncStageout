#
# The monitor requires the PHEDEX-micro package to function.
# Testing it in standalone (emulated) mode also requires the
# PHEDEX-lifecycle package.
#
# The script below should set up your environment if you have
# the software installed. You'll need to check if it needs
# any modification, that's up to you...
#
unset PERL5LIB
root=/data/current
